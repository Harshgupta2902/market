...
! function(t, e) {
    ...
    function Bo(t) {
        return (t.scale || {}).getPointPositionForValue ? function(t) {
            ...
            let l, c, h;
            if (h = "start" === i ? a : "end" === i ? r : U(i) ? i.value : e.getBaseValue(), n.grid.circular) return c = e.getPointPositionForValue(0, a), new Vo({
                x: c.x,
                y: c.y,
    ...
    var Qo = {
        ...
        beforeDatasetDraw(t, e) {
            ...
            s && a.points.length && (Gt(n, i), function(t, e) {
                ...
                t.save(), "x" === l && s !== o && (Uo(t, n, a.top), Zo(t, {
                    line: i,
                    target: n,
                    color: o,
                    scale: r,
                    property: l
                }), t.restore(), t.save(), Uo(t, n, a.bottom)), Zo(t, {
                    line: i,
                    target: n,
                    color: s,
                    scale: r,
    ...
    class ts extends Oi {
        ...
        _draw() {
            ...
            const {
                ...
                boxHeight: b,
                itemHeight: _
            } = Jo(l, g), y = t.isHorizontal(), v = this._computeTitleHeight();
            m = y ? {
    ...
    class ps extends Oi {
        ...
        drawTitle(t, e, i) {
            ...
            if (s) {
                ...
                for (t.x = us(n, i.titleAlign, i), e.textAlign = c.textAlign(i.titleAlign), e.textBaseline = "middle", a = Ee(i.titleFont), r = i.titleSpacing, e.fillStyle = i.titleColor, e.font = a.string, l = 0; l < s; ++l) e.fillText(o[l], c.x(t.x), t.y + a.lineHeight / 2), t.y += a.lineHeight + r, l + 1 === s && (t.y += i.titleMarginBottom - r)
            }
        }
        ...
        drawFooter(t, e, i) {
            ...
            if (s) {
                ...
                for (t.x = us(n, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = l.textAlign(i.footerAlign), e.textBaseline = "middle", a = Ee(i.footerFont), e.fillStyle = i.footerColor, e.font = a.string, r = 0; r < s; ++r) e.fillText(o[r], l.x(t.x), t.y + a.lineHeight / 2), t.y += a.lineHeight + i.footerSpacing
            }
        }
    ...
    class ys extends ji {
        ...
        buildTicks() {
            ...
            const o = function(t, e) {
                ...
                for (f && (i.push({
                        value: o
                    }), x <= o && v++, Ot(Math.round((x + v * y) * m) / m, o, y / 10) && v++); v < _; ++v) i.push({
    ...
    class Os extends ys {
        ...
        generateTickLabels(t) {
            const e = this;
            ys.prototype.generateTickLabels.call(e, t), e._pointLabels = e.getLabels().map(((t, i) => {
        ...
        buildTicks() {
            ...
            return t._unit = i.unit || (n.autoSkip ? Is(i.minUnit, t.min, t.max, t._getLabelCapacity(s)) : function(t, e, i, n, o) {
                for (let s = Ls.length - 1; s >= Ls.indexOf(i); s--) {
                    const i = Ls[s];
                    if (Ts[i].common && t._adapter.diff(o, n, i) >= e - 1) return i
                }
    ...
    return Yn.register(co, Hs, Eo, xs), Yn.helpers = { ...vn
